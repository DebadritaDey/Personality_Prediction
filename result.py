...
# Download the 'stopwords' dataset for nltk
import nltk
...
def prediction_result(top, aplcnt_name, cv_path, personality_values):
  ...
  #  result.geometry('700x550')
    ...
    # It should be aligned with the previous line to be part of the function body.
    ...
    # ... (Rest of your code within prediction_result function)
...
if __name__ == "__main__":
    ...
    if "DISPLAY" in os.environ:
        ...
        print("GUI cannot be launched. No display available.")